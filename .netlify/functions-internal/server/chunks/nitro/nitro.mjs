...
const _lazy_I1Vq8x = () => import('../routes/api/user/received-cards/_id_.get.mjs');
const _lazy_JZz_eu = () => import('../routes/api/user/wallet.get.mjs');
const _lazy_g5roFv = () => import('../routes/api/user/withdraw.post.mjs');
...
const handlers = [
  ...
  { route: '/api/user/received-cards/:id', handler: _lazy_I1Vq8x, lazy: true, middleware: false, method: "get" },
  { route: '/api/user/wallet', handler: _lazy_JZz_eu, lazy: true, middleware: false, method: "get" },
  { route: '/api/user/withdraw', handler: _lazy_g5roFv, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_wyzq9G, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_wyzq9G, lazy: true, middleware: false, method: undefined }
];
