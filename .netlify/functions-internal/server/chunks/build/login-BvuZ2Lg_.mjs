import { u as useI18n, a as useLocalePath, b as useSupabaseClient, _ as __nuxt_component_0, n as navigateTo } from './server.mjs';
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_NuxtLink, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("auth.register"))} \u2192 `);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("auth.register")) + " \u2192 ", 1)
                  ];
                }
              }),
              _: 1
            ...
            return [
              createVNode("div", { class: "card-container p-6 animate-fade-in" }, [
                createVNode("h2", { class: "text-xl font-bold text-center mb-6" }, toDisplayString(unref(t)("auth.login_to_continue")), 1),
                createVNode("form", {
                  ...
                  }, toDisplayString(unref(loading) ? unref(t)("common.loading") : unref(t)("auth.login_button")), 9, ["disabled"])
                ], 32),
                ...
                createVNode("button", {
                  ...
                  class: "btn-secondary w-full !py-3 mb-3",
                  disabled: unref(loading)
                }, " \u2709\uFE0F " + toDisplayString(unref(t)("auth.magic_link")), 9, ["disabled"]),
                createVNode("button", {
...
//# sourceMappingURL=login-BvuZ2Lg_.mjs.map
