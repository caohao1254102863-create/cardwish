...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const earnings = computed(() => {
      var _a;
      return ((_a = earningsData.value) == null ? void 0 : _a.earnings) || [];
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if ((((_d = unref(w)) == null ? void 0 : _d.balance_cents) || 0) >= unref(minWithdrawal)) {
        ...
        _push(`<p class="text-center text-xs text-gray-400 mt-3">${ssrInterpolate(unref(t)("wallet.min_withdrawal", { amount: "$" + formatPrice(unref(minWithdrawal)) }))}</p>`);
      }
      _push(`</div><div class="px-4"><h3 class="font-semibold text-gray-700 mb-3">${ssrInterpolate(unref(t)("wallet.earnings_title"))}</h3>`);
      if (unref(loadingEarnings)) {
...
//# sourceMappingURL=wallet-ByhBxtqb.mjs.map
